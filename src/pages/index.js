...
export default () => (
    <Layout>
        ...
        <p>Still not sure about design choices. I'd like it to be somewhat minimialistic, but now I realize why tons of modern design choices have horizontal
            navigation bars. </p>
        <p>Here is some filler text to test some stuff.</p>
